 ...
 */
    ...
    public NotificationTest(boolean isBackground, int notification_type, int notification_style, int notification_priority, String title, String message, String image_url, String timestamp, JSONObject payload) {
